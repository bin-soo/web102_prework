...
console.log(`numUnfundedGames: ${numUnfundedGames}`);

// create a string that explains the number of unfunded games using the ternary operator
const unfundedRemainString = numUnfundedGames === 1 ? "remains" : "remain";
// descriptionContainer.innerHTML = `
//     <h2>Who We Are</h2>
//     <p>Our company has ${GAMES_JSON.length} games in total, while ${numUnfundedGames} of them ${unfundedRemainString} unfunded.</p>
// `;
...
console.log("toLocaleString<div>1ivy".length);
/************************************************************************************
...
console.log(`topGame: ${topGame.name}`);
console.log(`runnerUpGame: ${runnerUpGame.name}`);
